...
function PixelImagePair({ img1, img2, caption1, caption2, accent, href }) {
  return (
    <div className="relative mx-auto h-[360px] w-[300px] sm:h-[460px] sm:w-[380px] md:h-[500px] md:w-[420px] lg:h-[560px] lg:w-[480px]">
      <motion.a
        href={href}
        target="_blank"
        rel="noreferrer"
        ...
        style={{ border: `4px solid ${accent}`, boxShadow: `8px 8px 0 rgba(0,0,0,0.65)`, imageRendering: 'pixelated' }}
      >
      ...
      <motion.a
        ...
        style={{ border: `4px solid ${accent}`, boxShadow: `8px 8px 0 rgba(0,0,0,0.65)` }}
      >
  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundImage:
          'linear-gradient(180deg, var(--gallery-bg) 0%, var(--gallery-bg2) 100%), linear-gradient(var(--gallery-grid) 4px, transparent 4px), linear-gradient(90deg, var(--gallery-grid) 4px, transparent 4px)',
